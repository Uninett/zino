...
from zino.utils import file_is_readable_by_others, log_time_spent, parse_ip, reverse_dns
...
class TestFileIsReadableByOthers:
    def test_return_true_if_file_is_world_readable(self, secrets_file):
        assert file_is_readable_by_others(secrets_file)
    ...
    def test_return_if_file_is_only_readable_by_owner(self, tmp_path):
        ...
        assert not file_is_readable_by_others(name)
